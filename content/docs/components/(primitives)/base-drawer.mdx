...
Bottom drawers keep focused fields clear of the on-screen keyboard. Fields in `BaseDrawerPanel` scroll into view, and a field in `BaseDrawerFooter`, like a reply box, lifts the footer above the keyboard while it has focus. No props needed.
