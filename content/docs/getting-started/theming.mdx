...
Cubby UI uses [OKLCH colors](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value/oklch) for theming. OKLCH provides perceptually uniform colors, making it easier to create accessible, consistent palettes across light and dark modes.
...
:root {
  ...
  /* Effects */
  --top-highlight: inset 0 0.75px 0.75px oklch(100 0 0 / 0.64);
}
...
@theme inline {
  ...
  /* Shadows */
  --shadow-top-highlight: var(--top-highlight);
