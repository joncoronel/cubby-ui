...
_Directly inspired by shadcn's [`scroll-fade`](https://ui.shadcn.com/docs/utils/scroll-fade) utility, adapted for Cubby UI with a couple of refinements: a fixed-pixel reveal clamped to the scroll range so short scrollers still fully reveal._
