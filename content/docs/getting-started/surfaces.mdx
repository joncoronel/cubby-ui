...
```css
--input:          var(--surface-3);
   /* Opaque, "clean lifted" form-field bg. Same value as a Card surface —
      pure white in light, surface-3 in dark. */

--input-elevated: light-dark(oklch(0 0 0 / 0.08), oklch(1 0 0 / 0.12));
   /* Translucent overlay, same family as --surface-hover / --surface-selected
      but stronger (8% black light / 12% white dark). Adapts to any substrate. */
```
