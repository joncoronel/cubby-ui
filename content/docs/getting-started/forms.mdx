...
Applies to Input, Textarea, NumberFieldGroup (not NumberFieldInput), InputGroup, OTPFieldInput, ComboboxInput, ComboboxChips, AutocompleteInput, Checkbox, and RadioGroupItem. Switch handles this automatically; no variant prop needed. See the [Surfaces](/docs/getting-started/surfaces) docs for the full reasoning.
