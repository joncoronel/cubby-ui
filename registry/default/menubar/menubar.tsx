...
function Menubar({
  ...
  return (
    <BaseMenubar
      data-slot="menubar"
      className={cn(
        "bg-popover flex h-9 items-center gap-1 rounded-md border border-border/70 p-1 shadow-[0_2px_6px_0_oklch(0.18_0_0_/_0.05)] ",
        className,
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <BaseMenu.Trigger
      ...
      className={cn(
        "data-popup-open:bg-accent data-popup-open:text-accent-foreground flex items-center rounded-sm px-2.5 py-1 text-sm font-medium outline-hidden select-none transition-colors duration-200 hover:bg-accent/80 hover:text-accent-foreground",
        className,
      )}
      {...props}
    />
