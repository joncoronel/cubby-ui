...
Social media-style comments section with snap points for different viewing depths.

<ComponentPreview component="drawer" example="drawer-comments" />
...
<Drawer snapPoints={["92px", 1]}>
  ...
  <DrawerContent>
    ...
    {/* Full player fades in as drawer expands */}
    <div className="opacity-[var(--drawer-snap-progress,0)]">Full Player</div>
  </DrawerContent>
</Drawer>
```
