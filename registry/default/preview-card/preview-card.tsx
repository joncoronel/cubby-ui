    ...
    <PreviewCardPortal>
      <PreviewCardPositioner sideOffset={sideOffset} align={align}>
        <BasePreviewCard.Popup
          ...
          data-level={level}
          className={cn(
            "text-popover-foreground z-50 w-64 origin-[var(--transform-origin)] rounded-md p-3 transition-[transform,scale,opacity] data-[ending-style]:scale-95 data-[ending-style]:opacity-0 data-[starting-style]:scale-95 data-[starting-style]:opacity-0",
