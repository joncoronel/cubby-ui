...
.dark {
  ...
  --neutral-foreground: oklch(0.13 0 0);
...
@theme inline {
  ...
  /* Animations */
  --animate-skeleton: skeleton 2s -1s linear infinite;
  ...
  /* Inset shadows */
  --shadow-inset: 0 1px 2px 0 oklch(0 0 0 / 0.06);
