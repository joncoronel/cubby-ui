...
> Directly inspired by shadcn's [`shimmer`](https://ui.shadcn.com/docs/utils/shimmer) utility, adapted for Cubby UI and re-tuned to read well against its color tokens in light and dark.
