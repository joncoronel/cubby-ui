...
// Individual cubby shapes for decorative use
const leftCubbyPath =
...
export default function Image() {
  return new ImageResponse(
    ...
    >
      {/* Large decorative logo - right side, partially cropped */}
      <svg
        width="480"
        height="345"
        viewBox="0 0 354 255"
      ...
      >
        ...
        >
          Beautiful, accessible React components built with Tailwind CSS and
          Base UI
        </div>
