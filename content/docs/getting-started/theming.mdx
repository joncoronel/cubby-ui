...
:root {
  ...
  --sidebar-primary-foreground: oklch(
    0.97 var(--neutral-chroma) var(--neutral-hue)
  );
  --sidebar-accent: oklch(0.92 0 0);
  --sidebar-accent-foreground: oklch(
    0.28 var(--neutral-chroma) var(--neutral-hue)
  );
...
.dark {
  ...
  --sidebar-primary-foreground: oklch(
    0.13 var(--neutral-chroma) var(--neutral-hue)
  );
  --sidebar-accent: oklch(0.19 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-accent-foreground: oklch(
    0.95 var(--neutral-chroma) var(--neutral-hue)
  );
