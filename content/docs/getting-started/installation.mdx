...
<PackageManagerCommand npm="npx shadcn@latest add @cubby-ui/init" />
...
<PackageManagerCommand npm="npx shadcn@latest add @cubby-ui/button @cubby-ui/input @cubby-ui/card" />
