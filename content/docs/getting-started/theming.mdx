...
:root {
  ...
  --neutral-foreground: oklch(0.98 var(--neutral-chroma-low) var(--neutral-hue));
  ...
  --destructive-foreground: oklch(0.98 var(--neutral-chroma-low) var(--neutral-hue));
  ...
  --input-shadow:
    ...
    0 0 1px 0 oklch(0 0 0 / 0.06);
  --ring: oklch(0.55 0.2 250);
  --scrollbar: oklch(0.87 0 0);

  /* Sidebar colors */
  --sidebar: var(--surface-1);
  --sidebar-foreground: oklch(0.22 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-primary: oklch(0.28 0 0);
  --sidebar-primary-foreground: oklch(0.97 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-accent: oklch(0.92 0 0);
  --sidebar-accent-foreground: oklch(0.28 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-border: oklch(0.9 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-ring: oklch(0.65 var(--neutral-chroma) var(--neutral-hue));
...
.dark {
  ...
  --secondary: oklch(0.28 var(--neutral-chroma) var(--neutral-hue));
  ...
  /* Sidebar */
  --sidebar-foreground: oklch(0.88 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-primary: oklch(0.95 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-primary-foreground: oklch(0.13 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-accent: oklch(0.19 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-accent-foreground: oklch(0.95 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-border: oklch(0.28 var(--neutral-chroma) var(--neutral-hue));
  --sidebar-ring: oklch(0.83 var(--neutral-chroma) var(--neutral-hue));
  ...
  /* Form fields drop their lift in dark — hairline border per component */
...
- `--input-shadow`: 3-layer soft drop shadow for the `default` variant in light mode (transparent in dark; dark mode uses a hairline border instead)
