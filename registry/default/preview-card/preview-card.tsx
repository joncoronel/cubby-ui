    ...
    <PreviewCardPortal>
      <PreviewCardPositioner sideOffset={sideOffset} align={align}>
        <BasePreviewCard.Popup
          ...
          className={cn(
            "bg-popover text-popover-foreground outline-border/70 z-50 w-64 origin-[var(--transform-origin)] rounded-md p-3 shadow-[0_6px_20px_oklch(0_0_0_/_0.10)] outline -outline-offset-1 transition-[transform,scale,opacity] data-[ending-style]:scale-95 data-[ending-style]:opacity-0 data-[starting-style]:scale-95 data-[starting-style]:opacity-0",
            className,
          )}
          {...props}
        >
